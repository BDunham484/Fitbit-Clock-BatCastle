...
// Determine which battery image needs to be shown.
 ...
 function batteryLevel() {
   if (battery.chargeLevel > 90) {
    batImg.href = "battery-100.png";
 } else if (battery.chargeLevel < 90 && battery.chargeLevel >= 60) {
    batImg.href = "battery-80.png";
 } else if (battery.chargeLevel < 60 && battery.chargeLevel >= 45) {
    batImg.href = "battery-60.png";
 } else if (battery.chargeLevel < 45 && battery.chargeLevel >= 30) {
    batImg.href = "battery-40.png";
 } else if (battery.chargeLevel < 30 && battery.chargeLevel >= 15) {
    batImg.href = "battery-20.png";
 } else if (battery.chargeLevel < 15 && battery.chargeLevel >= 5) {
    batImg.href = "battery-almost-dead.png";
 } else {
    batImg.href = "battery-dead.png";
 }
 }
